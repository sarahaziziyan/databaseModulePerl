...
sub connectToOracle{
    ...
    my $e_msg   = "";
    use DBI;
    my %commonConfig = do "/tmp/config/common.cfg";     ## config file that describes genral information about the database
    my %schemaConfig = do "/tmp/config/schemas.cfg";    ## confir file that specifies username and password for the schemas
